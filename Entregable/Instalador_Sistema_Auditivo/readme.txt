==================================================================================
		Proyecto Final "Sistema Autditivo"
...
Proyecto en el que se presenta un recorrido virtual para ilustrar la organización 
tonotópica del cerebro. El tema elegido fue basado en el interés de los integrantes 
del equipo por las aplicaciones del cómputo gráfico en el área médica y sus 
beneficios.

==================================================================================
			Contenido
==================================================================================
Este proyecto contiene todos los archivos necesarios para  el funcionamiento de la 
aplicación. Una vez  instalado en su computadora, la aplicación va acompañada de 
algunas subcarpetas, cuyo contenido se describe a continuación:
